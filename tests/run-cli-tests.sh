...
COMMAND_LINE_HANDLER=ClapCommandLineHandler "$BATS_DIR/bin/bats" $BATS_OPTIONS tests/pharo-cli-perform/pharo-cli-perform.bats
COMMAND_LINE_HANDLER=PerformMessageCommandLineHandler "$BATS_DIR/bin/bats" $BATS_OPTIONS tests/pharo-cli-perform/pharo-cli-perform.bats
